...
const TierCard = ({ image, description, price, onClick }) => {
  return (
    <div className="flex border border-black rounded-[20px] w-full pr-8">
      ...
      <div className="flex items-center">
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="text-gray-700">{`${price} Matic / Month`}</p>
          <button className="bg-black text-white px-20 py-2 rounded-lg mt-2" onClick={onClick}>
            Join
          </button>
        </div>
      </div>
