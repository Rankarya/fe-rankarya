...
const PostUser = () => {
  ...
  const handleNext = () => {
    ...
    setFileNumber(nextSlide + 1); // Update file number on slide change
  };
  
  const handlePrev = () => {
    const prevSlide = currentSlide === 0 ? data.length - 1 : currentSlide - 1;
    setCurrentSlide(prevSlide);
    setFileNumber(prevSlide + 1); // Update file number on slide change
  };
      ...
      <div className="">
        ...
        <div className="basis-1/2 pt-2 pl-8 pr-8 pb-8">
            ...
            <div className='flex mt-2'>
                <Link to={`/postUser`} className="font-medium text-black dark:text-gray-700 hover:underline" onClick={toggleLike}>
                ...
                <Link to={`/postUser`} className="font-medium text-black dark:text-gray-700 hover:underline mx-1" onClick={toggleComments}>
                ...
                <Link to={`/postUser`} className="font-medium text-black dark:text-gray-700 hover:underline mx-1" onClick={toggleModal}>
                ...
                <Link to={`/postUser`} className="font-medium text-black dark:text-gray-700 hover:underline mx-1" onClick={toggleReport}>
                    ...
                    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center">
                        <div className="bg-white p-4 rounded-xl">
                            ...
                            <div className="flex justify-end mt-4">
                                <button className="mr-2 bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded-md" onClick={() => setIsReportModalOpen(false)}>
                                Cancel
                                </button>
                                <button className="bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-md" onClick={() => { handleReport(); setIsReportModalOpen(false); }}>
                                Report
                                </button>
                            </div>
                        </div>
            ...
            {showComments && (
                ...
                <div className='flex justify-center items-center'>
                    <Link to={`/postUser`} className="text-black font-semibold" onClick={toggleComments}>
