        ...
        <div className="basis-1/2 p-8">
          ...
          <div className='flex mt-2'>
            <Link to={`/post`} className="font-medium text-black dark:text-gray-700 hover:underline" onClick={toggleLike}>
              <svg xmlns="http://www.w3.org/2000/svg" fill={liked ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth="1.5" stroke={liked ? 'currentColor' : 'currentColor'} className="w-6 h-6">
            ...
            <Link to={`/post`} className="font-medium text-black dark:text-gray-700 hover:underline mx-1" onClick={toggleComments}>
              <svg xmlns="http://www.w3.org/2000/svg" fill={showComments ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth="1.5" stroke={showComments ? 'currentColor' : 'currentColor'} className="w-6 h-6">
