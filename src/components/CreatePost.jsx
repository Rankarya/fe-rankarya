  ...
  return (
    <div className='mt-10'>
      <div className="text-center py-3">
        <button className="bg-purple-800 text-white px-5 py-2 rounded hover:scale-95 transition text-md" onClick={openModal}>
          Create Post
        </button>
      </div>

      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center" onClick={closeModal}>
          <div className="bg-white w-full max-w-[400px] sm:max-w-lg rounded-[20px] shadow-md overflow-hidden lg:max-w-3xl" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-center border-transparent bg-gray-200 rounded-[20px] rounded-bl-none rounded-br-none relative h-[70px]">
              <h1 className="font-semibold text-xl text-gray-700 mx-auto pl-14">Create Post</h1>
