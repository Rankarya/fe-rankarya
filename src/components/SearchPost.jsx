...
const SearchPost = () => {
    ...
    return (
        <div className="sm:max-w-md mx-auto mb-15 flex-col">
            <div className="flex items-center border border-black px-4 py-2 my-2 rounded w-full focus-within:border-gray-600">
                ...
                />
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-600 pointer-events-none">
